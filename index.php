...
<html lang="en">
  ...
  <body>
    ...
    <form action="data.php" method="post" autocomplete="off">
        ...
        <button type="submit" class="btn btn-success" name="submit">Add To ToDo'S</button>
  ...
  <tbody>
            ...
            $res=mysqli_query($conn,"SELECT * FROM todos1 where unqid='$unqid'");
            while($row=mysqli_fetch_array($res))
            {
              ...
              <td>
              <a class="btn btn-success btn-sm" href="edit.php?id=<?php echo $_SESSION['id'] ?>" role="button">Edit</a>
              <a class="btn btn-danger btn-sm" href="delete.php?id=<?php echo $_SESSION['id'] ?>" role="button">Delete</a>
